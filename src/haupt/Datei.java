...
public class Datei {
	...
	public static void read(){
		...
		char feld[][] = new char [30][30];
		try { 
	SAXBuilder builder = new SAXBuilder();
	Document doc = builder.build("C:/Dokumente und Einstellungen/Laptop/Desktop/Spielfeld.xml"); // bis jetzt statischer Dateipfad; hier kommt martin ins spiel
	...
	Element reihe_29 = spielfeld.getChild("zeile_29");
	String r29 = reihe_29.getText();
	 
	Element reihe_30 = spielfeld.getChild("zeile_30");
	String r30 = reihe_30.getText();
		...
		for (int j=0;j<30;j++)
		{
			for (int i=0;i<30;i++)
			{
					...
					case 27: 
						...
						break;
					case 28:
						feld[i][j]=r29.charAt(i);
						break;
					case 29: 
						feld[i][j]=r30.charAt(i);
						break;
					}
			}
		}
