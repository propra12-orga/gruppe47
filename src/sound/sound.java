...
implements Runnable, LineListener, MetaEventListener, ActionListener
{
    ...
    /** erstellt und öffnet den sequencer **/
    public void open()
    {
        try
        {
    ...
    public void close()
    {
        ...
        /** wenn der sequencer geöffnet ist **/
        if (sequencer != null)
        {
            /** schließen **/
            sequencer.close();
    ...
    /** läd alle Sound Dateien in ein Verzeichnis **/
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        /** wenn der nächste button geklickt wurde */
        else if (button.getText().equals(">>"))
        {
            paused = false;
            /** ändere button Text */
            pauseB.setText("Pause");
            /** gehe zum nächsten sound */
